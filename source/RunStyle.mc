...
//! Colors shared by the raster running screen.
module RunStyle {
    const MAP_BACKGROUND = 0xF2EFE7;
    const TEXT = Graphics.COLOR_BLACK;
    ...
    const RECORDING = 0x00D7FF;
    const PAUSED = 0xFFB020;
    const ERROR = 0xFF4040;
}
